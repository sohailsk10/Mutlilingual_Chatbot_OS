...
def main( params ):
    ...
    try:
        ...
        translator = LanguageTranslatorV3(
            ...
            # bhai thoda der ruko call aaya hai
        )
    except:
        return {
    ...
    try:
        print("---", params['text'])
        print("params['session_val]", params['session_val'])
        print(params['text'] != None)
        print(params['session_val'] == '')
        print('params', params['text'] != None and params['session_val'] == '' )
        text = params['text']
        sess_id = params['session_val']
        # context = json.loads(params['context'])
        # session_created = True
        print('param text',text, sess_id)
    ...
    print('------------session_created with id', sess_id)
